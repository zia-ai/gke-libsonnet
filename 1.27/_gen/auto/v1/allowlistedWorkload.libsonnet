{
  ...
  '#':: d.pkg(name='allowlistedWorkload', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of AllowlistedWorkload', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    containers: {
      '#exemptions':: d.obj(help=''),
      exemptions: {
        '#withConstraintName':: d.fn(help='', args=[d.arg(name='constraintName', type=d.T.string)]),
        withConstraintName(constraintName): { constraintName: constraintName },
        '#withConstraintParameters':: d.fn(help='', args=[d.arg(name='constraintParameters', type=d.T.object)]),
        withConstraintParameters(constraintParameters): { constraintParameters: constraintParameters },
        '#withConstraintParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='constraintParameters', type=d.T.object)]),
        withConstraintParametersMixin(constraintParameters): { constraintParameters+: constraintParameters },
      },
      ...
      '#withPodAnnotations':: d.fn(help='', args=[d.arg(name='podAnnotations', type=d.T.array)]),
      withPodAnnotations(podAnnotations): { podAnnotations: if std.isArray(v=podAnnotations) then podAnnotations else [podAnnotations] },
      '#withPodAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podAnnotations', type=d.T.array)]),
      withPodAnnotationsMixin(podAnnotations): { podAnnotations+: if std.isArray(v=podAnnotations) then podAnnotations else [podAnnotations] },
      '#withPodLabels':: d.fn(help='', args=[d.arg(name='podLabels', type=d.T.array)]),
      withPodLabels(podLabels): { podLabels: if std.isArray(v=podLabels) then podLabels else [podLabels] },
      '#withPodLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podLabels', type=d.T.array)]),
      withPodLabelsMixin(podLabels): { podLabels+: if std.isArray(v=podLabels) then podLabels else [podLabels] },
    },
