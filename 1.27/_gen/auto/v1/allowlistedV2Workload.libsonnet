{
  ...
  '#':: d.pkg(name='allowlistedV2Workload', url='', help='"AllowlistedV2Workload describes a workload pattern that should be exempt from certain policies for allowlistv2."'),
  ...
  '#new':: d.fn(help='new returns an instance of AllowlistedV2Workload', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'auto.gke.io/v1',
    kind: 'AllowlistedV2Workload',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'false',
  }),
  '#podSpec':: d.obj(help='"PodSpec is a description of a pod."'),
  podSpec: {
    ...
    affinity: {
      ...
      nodeAffinity: {
        ...
        requiredDuringSchedulingIgnoredDuringExecution: {
          ...
          withNodeSelectorTerms(nodeSelectorTerms): { podSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } },
          ...
          withNodeSelectorTermsMixin(nodeSelectorTerms): { podSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } },
        },
      ...
      podAffinity: {
        ...
        '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        ...
        withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
        ...
        withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
      },
      ...
      podAntiAffinity: {
        ...
        withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling anti-affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        ...
        withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
        '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { podSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
      },
    },
    ...
    dnsConfig: {
      ...
      withNameservers(nameservers): { podSpec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } },
      ...
      withNameserversMixin(nameservers): { podSpec+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } },
      ...
      withOptions(options): { podSpec+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } },
      ...
      withOptionsMixin(options): { podSpec+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } },
      ...
      withSearches(searches): { podSpec+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } },
      ...
      withSearchesMixin(searches): { podSpec+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } },
    },
    ...
    os: {
      ...
      withName(name): { podSpec+: { os+: { name: name } } },
    },
    ...
    securityContext: {
      ...
      seLinuxOptions: {
        '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { podSpec+: { securityContext+: { seLinuxOptions+: { level: level } } } },
        '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
        withRole(role): { podSpec+: { securityContext+: { seLinuxOptions+: { role: role } } } },
        '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { podSpec+: { securityContext+: { seLinuxOptions+: { type: type } } } },
        '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
        withUser(user): { podSpec+: { securityContext+: { seLinuxOptions+: { user: user } } } },
      },
      ...
      seccompProfile: {
        '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used. The profile must be preconfigured on the node to work. Must be a descending path, relative to the kubelet's configured seccomp profile location. Must only be set if type is \\\"Localhost\\\".\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
        withLocalhostProfile(localhostProfile): { podSpec+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } },
        '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied. Valid options are: \\n Localhost - a profile defined in a file on the node should be used. RuntimeDefault - the container runtime default profile should be used. Unconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { podSpec+: { securityContext+: { seccompProfile+: { type: type } } } },
      },
      ...
      windowsOptions: {
        '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
        withGmsaCredentialSpec(gmsaCredentialSpec): { podSpec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } },
        '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
        withGmsaCredentialSpecName(gmsaCredentialSpecName): { podSpec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } },
        '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. This field is alpha-level and will only be honored by components that enable the WindowsHostProcessContainers feature flag. Setting this field without the feature flag will result in errors when validating the Pod. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).  In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
        withHostProcess(hostProcess): { podSpec+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } },
        '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
        withRunAsUserName(runAsUserName): { podSpec+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } },
      },
      ...
      withFsGroup(fsGroup): { podSpec+: { securityContext+: { fsGroup: fsGroup } } },
      ...
      withFsGroupChangePolicy(fsGroupChangePolicy): { podSpec+: { securityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } },
      ...
      withRunAsGroup(runAsGroup): { podSpec+: { securityContext+: { runAsGroup: runAsGroup } } },
      ...
      withRunAsNonRoot(runAsNonRoot): { podSpec+: { securityContext+: { runAsNonRoot: runAsNonRoot } } },
      '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container. Note that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
      withRunAsUser(runAsUser): { podSpec+: { securityContext+: { runAsUser: runAsUser } } },
      ...
      withSupplementalGroups(supplementalGroups): { podSpec+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      ...
      withSupplementalGroupsMixin(supplementalGroups): { podSpec+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      ...
      withSysctls(sysctls): { podSpec+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } },
      ...
      withSysctlsMixin(sysctls): { podSpec+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } },
    },
    ...
    withActiveDeadlineSeconds(activeDeadlineSeconds): { podSpec+: { activeDeadlineSeconds: activeDeadlineSeconds } },
    ...
    withAutomountServiceAccountToken(automountServiceAccountToken): { podSpec+: { automountServiceAccountToken: automountServiceAccountToken } },
    ...
    withContainers(containers): { podSpec+: { containers: if std.isArray(v=containers) then containers else [containers] } },
    ...
    withContainersMixin(containers): { podSpec+: { containers+: if std.isArray(v=containers) then containers else [containers] } },
    ...
    withDnsPolicy(dnsPolicy): { podSpec+: { dnsPolicy: dnsPolicy } },
    ...
    withEnableServiceLinks(enableServiceLinks): { podSpec+: { enableServiceLinks: enableServiceLinks } },
    ...
    withEphemeralContainers(ephemeralContainers): { podSpec+: { ephemeralContainers: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } },
    ...
    withEphemeralContainersMixin(ephemeralContainers): { podSpec+: { ephemeralContainers+: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } },
    ...
    withHostAliases(hostAliases): { podSpec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    ...
    withHostAliasesMixin(hostAliases): { podSpec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    '#withHostIPC':: d.fn(help="\"Use the host's ipc namespace. Optional: Default to false.\"", args=[d.arg(name='hostIPC', type=d.T.boolean)]),
    withHostIPC(hostIPC): { podSpec+: { hostIPC: hostIPC } },
    ...
    withHostname(hostname): { podSpec+: { hostname: hostname } },
    ...
    withImagePullSecrets(imagePullSecrets): { podSpec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } },
    ...
    withImagePullSecretsMixin(imagePullSecrets): { podSpec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } },
    ...
    withInitContainers(initContainers): { podSpec+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } },
    ...
    withInitContainersMixin(initContainers): { podSpec+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } },
    ...
    withNodeName(nodeName): { podSpec+: { nodeName: nodeName } },
    ...
    withNodeSelector(nodeSelector): { podSpec+: { nodeSelector: nodeSelector } },
    ...
    withNodeSelectorMixin(nodeSelector): { podSpec+: { nodeSelector+: nodeSelector } },
    ...
    withOverhead(overhead): { podSpec+: { overhead: overhead } },
    ...
    withOverheadMixin(overhead): { podSpec+: { overhead+: overhead } },
    ...
    withPreemptionPolicy(preemptionPolicy): { podSpec+: { preemptionPolicy: preemptionPolicy } },
    ...
    withPriority(priority): { podSpec+: { priority: priority } },
    ...
    withPriorityClassName(priorityClassName): { podSpec+: { priorityClassName: priorityClassName } },
    ...
    withReadinessGates(readinessGates): { podSpec+: { readinessGates: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } },
    ...
    withReadinessGatesMixin(readinessGates): { podSpec+: { readinessGates+: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } },
    ...
    withRestartPolicy(restartPolicy): { podSpec+: { restartPolicy: restartPolicy } },
    ...
    withRuntimeClassName(runtimeClassName): { podSpec+: { runtimeClassName: runtimeClassName } },
    ...
    withSchedulerName(schedulerName): { podSpec+: { schedulerName: schedulerName } },
    ...
    withServiceAccount(serviceAccount): { podSpec+: { serviceAccount: serviceAccount } },
    ...
    withServiceAccountName(serviceAccountName): { podSpec+: { serviceAccountName: serviceAccountName } },
    ...
    withSetHostnameAsFQDN(setHostnameAsFQDN): { podSpec+: { setHostnameAsFQDN: setHostnameAsFQDN } },
    ...
    withShareProcessNamespace(shareProcessNamespace): { podSpec+: { shareProcessNamespace: shareProcessNamespace } },
    ...
    withSubdomain(subdomain): { podSpec+: { subdomain: subdomain } },
    ...
    withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { podSpec+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } },
    '#withTolerations':: d.fn(help="\"If specified, the pod's tolerations.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerations(tolerations): { podSpec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    ...
    withTolerationsMixin(tolerations): { podSpec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    ...
    withTopologySpreadConstraints(topologySpreadConstraints): { podSpec+: { topologySpreadConstraints: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } },
    ...
    withTopologySpreadConstraintsMixin(topologySpreadConstraints): { podSpec+: { topologySpreadConstraints+: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } },
    ...
    withVolumes(volumes): { podSpec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    ...
    withVolumesMixin(volumes): { podSpec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } },
  },
  '#withExemptions':: d.fn(help='"GKE Warden constraints that this allowlisted workload is exempt from."', args=[d.arg(name='exemptions', type=d.T.array)]),
  withExemptions(exemptions): { exemptions: if std.isArray(v=exemptions) then exemptions else [exemptions] },
  '#withExemptionsMixin':: d.fn(help='"GKE Warden constraints that this allowlisted workload is exempt from."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exemptions', type=d.T.array)]),
  withExemptionsMixin(exemptions): { exemptions+: if std.isArray(v=exemptions) then exemptions else [exemptions] },
  '#withMaxGKEVersion':: d.fn(help='', args=[d.arg(name='maxGKEVersion', type=d.T.string)]),
  withMaxGKEVersion(maxGKEVersion): { maxGKEVersion: maxGKEVersion },
  '#withMinGKEVersion':: d.fn(help='', args=[d.arg(name='minGKEVersion', type=d.T.string)]),
  withMinGKEVersion(minGKEVersion): { minGKEVersion: minGKEVersion },
